...
const errorMapping = {
    ...
    "Failed to delete user account": { status: 500, message: "Failed to delete user account. Please try again." },
    "Failed reset password": { status: 400, message: "Failed to reset password. Please try again." },
    "Failed to add user": { status: 500, message: "Failed to add user. Please try again." },
